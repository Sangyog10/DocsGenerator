...
exports.DocumentationRenderer = void 0;
class DocumentationRenderer {
    renderDocumentation(docs, format) {
        switch (format) {
            case 'markdown':
...
exports.DocumentationRenderer = DocumentationRenderer;
//# sourceMappingURL=documentationRenderer.js.map